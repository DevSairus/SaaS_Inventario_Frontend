      ...
      <div className="space-y-6">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                title={!(currentSale?.customer?.phone || currentSale?.customer?.mobile) ? 'El cliente no tiene teléfono registrado' : 'Enviar por WhatsApp'}
        ...
        <div className="no-print">
          <ConfirmSaleWithPaymentModal
            ...
            currentDocType={sale?.document_type || 'remision'}
