    ...
    <Layout>
      <div className="max-w-6xl mx-auto space-y-5">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Nueva Devolución de Cliente</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Selecciona una venta y los productos a devolver</p>
          </div>
        </div>

        {/* Search Sale */}
        {!selectedSale && (
          <div className="bg-white dark:bg-graphite rounded-lg shadow-sm p-6 mb-6">
            <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Buscar Venta</h2>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 dark:placeholder-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
              <button
                onClick={searchSales}
              ...
              <div className="mt-4 space-y-2">
                {sales.map((sale) => (
                  <div
                    ...
                    className="p-4 border border-gray-200 dark:border-white/10 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 cursor-pointer"
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-medium text-gray-900 dark:text-gray-100">{sale.sale_number}</p>
        ...
        {selectedSale && (
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Sale Info */}
            <div className="bg-white dark:bg-graphite rounded-lg shadow-sm p-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Venta: {selectedSale.sale_number}</h2>
                  <p className="text-gray-600 dark:text-gray-400">Cliente: {selectedSale.customer_name}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500"
                    required
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 dark:placeholder-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500"
                    rows="2"
            ...
            {/* Items */}
            <div className="bg-white dark:bg-graphite rounded-lg shadow-sm p-6">
              <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Productos a Devolver</h2>
                      ...
                      <tr key={index}>
                        ...
                        <td className="px-4 py-3">
                          <input
                            ...
                            className="w-24 px-2 py-1 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 rounded focus:ring-2 focus:ring-blue-500"
                          />
                        </td>
                        <td className="px-4 py-3">
                          <select
                            ...
                            className="px-2 py-1 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 rounded focus:ring-2 focus:ring-blue-500"
            ...
            <div className="flex justify-end gap-4">
              <button
                type="button"
                onClick={() => navigate('/sales/customer-returns')}
                className="px-6 py-2 border border-gray-300 dark:border-white/10 dark:text-gray-100 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5"
              >
                Cancelar
              </button>
              <button
