...
export default function NoBranchAssignedPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 dark:bg-ink">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center dark:bg-graphite">
        <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-5 dark:bg-amber-900/30">
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-2 dark:text-gray-100">Sin sede asignada</h1>
        <p className="text-sm text-gray-500 mb-1 dark:text-gray-500">
