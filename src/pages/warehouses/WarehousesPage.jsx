  ...
  return (
    <Layout>
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl shadow-xl p-8 text-white">
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V7zm0 8a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zm12 0a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
                </svg>
                <h1 className="text-3xl font-bold">Bodegas</h1>
              </div>
              <p className="text-pink-100">Gestión de almacenes y ubicaciones</p>
            </div>
            <button
              onClick={openCreate}
              className="bg-white text-pink-600 font-semibold px-5 py-2.5 rounded-lg hover:bg-pink-50 transition-colors flex items-center gap-2 shadow"
            >
