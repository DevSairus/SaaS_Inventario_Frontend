...
const ConfirmPurchaseWithPaymentModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-graphite rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b dark:border-white/10">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Confirmar Compra</h2>
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Método de pago */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Método de Pago</label>
                ...
                <button
                  ...
                  className={`px-3 py-2.5 rounded-lg border-2 text-sm font-medium transition-all flex flex-col items-center gap-1 ${
                    paymentMethod === value
                      ...
                      : 'border-gray-300 dark:border-white/10 bg-white dark:bg-graphite-2 text-gray-700 dark:text-gray-300 hover:border-pink-300'
                  }`}
                >
          ...
          {/* Tipo de pago */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Tipo de Pago</label>
                ...
                <button
                  ...
                  className={`px-3 py-2.5 rounded-lg border-2 text-sm font-medium transition-all flex flex-col items-center gap-0.5 ${
                    paymentType === key
                      ...
                      : `border-gray-300 dark:border-white/10 bg-white dark:bg-graphite-2 text-gray-700 dark:text-gray-300 hover:border-${color}-300`
                  }`}
                >
          ...
          {paymentType === 'partial' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Monto abonado ahora</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-7 pr-3 py-2 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                />
              </div>
          ...
          {(paymentType === 'partial' || paymentType === 'credit') && (
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-white/10 dark:bg-graphite-2 dark:text-gray-100 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-transparent"
              />
              {effectiveDays > 0 && (
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
        ...
        <div className="flex items-center justify-end gap-3 p-5 border-t dark:border-white/10 bg-gray-50 dark:bg-graphite-2 rounded-b-xl">
          <button
            onClick={onClose}
            disabled={loading}
            className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/10 rounded-lg disabled:opacity-50"
          >
            Cancelar
          </button>
          <button
